...
while running:
    ...
    # 무기 위치 조정
    # 100, 200 -> 180, 160, 140 ... (y좌표가 줄어든다 -> x는 그대로)
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        else: # 그 외의 모든 경우에는 속도를 증가 -> 포물선을 그리게 됨.
            ball_val["to_y"] += 0.5
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                    ...
                    balls.append({
                            ...
                            "img_idx" : ball_img_idx + 1,  # 공의 이미지 인덕스
                            "to_x" : -3,     # x축 이동방향, -3이면 왼쪽으로, 3이면 오른쪽으로
                            "to_y" : -6,    # y축 이동방향
    ...
    timer = game_font.render("Time : {0}".format(int(total_time - elapesed_time)), True, (255, 255, 255))
