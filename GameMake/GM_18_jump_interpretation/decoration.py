...
class Sky:
    def __init__(self, horizon, style = 'level'):
        ...
        if self.style == 'overworld':
            palm_surfaces = import_folder('C:\\Users\\lkjun\\OneDrive\\바탕 화면\\PythonWorkspace\\python_study\\Python_practice\\GameMake\\GM_8_7\\graphics\\overworld\\palms')
            self.palms = []
            ...
            cloud_surfaces = import_folder('C:\\Users\\lkjun\\OneDrive\\바탕 화면\\PythonWorkspace\\python_study\\Python_practice\\GameMake\\GM_8_7\\graphics\\overworld\\clouds')
            self.clouds = []
...
class Water:
    def __init__(self, top, level_width):
        ...
        for tile in range(tile_x_amount):
            ...
            y = top
            sprite = AnimatedTile(192, x, y, 'C:\\Users\\lkjun\\OneDrive\\바탕 화면\\PythonWorkspace\\python_study\\Python_practice\\GameMake\\GM_7\\graphics\\decoration\\water')
...
class Clouds:
    def __init__(self, horizon, level_width, cloud_number):
        cloud_surf_list = import_folder('C:\\Users\\lkjun\\OneDrive\\바탕 화면\\PythonWorkspace\\python_study\\Python_practice\\GameMake\\GM_7\\graphics\\decoration\\clouds')
        min_x = -screen_width
        max_x = level_width + screen_width
        min_y = 0
        max_y = horizon
        self.clound_sprites = pygame.sprite.Group()
    ...
    def draw(self, surface, shift):
        self.clound_sprites.update(shift)
